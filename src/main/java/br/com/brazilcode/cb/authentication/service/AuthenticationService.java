...
public class AuthenticationService {
	...
	public Authentication login(final HttpServletRequest request)
		...
		try {
			...
			final UserDTO usuario = userIntegrationService.findByUsernameAndPassword(username, password);

			final List<SimpleGrantedAuthority> authorities = usuario.getProfiles().stream()
			...
			throw new ServletException("[ AuthenticationService.login ] - ERROR during authentication");
		} finally {
